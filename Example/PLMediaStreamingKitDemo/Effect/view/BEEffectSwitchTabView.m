...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    BEEffectTitleCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([BEEffectTitleCollectionViewCell class]) forIndexPath:indexPath];
    [cell renderWithTitle:[self.categories objectAtIndex:indexPath.row].title];
    return cell;
}
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[BEEffectTitleCollectionViewCell class] forCellWithReuseIdentifier:NSStringFromClass([BEEffectTitleCollectionViewCell class])];
